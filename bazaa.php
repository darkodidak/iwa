...
function spojiSeNaBazu(){
	...
	if(!$veza){
		echo "GREŠKA: 
		Problem sa spajanjem u datoteci bazaa.php funkcija otvoriVezu:  
	...
	if(mysqli_error($veza)!==""){
		echo "GREŠKA: 
		Problem sa odabirom baze u bazaa.php funkcija otvoriVezu:  
		".mysqli_error($veza);
	}
...
function izvrsiUpit($veza, $upit){
	...
	if(mysqli_error($veza)!==""){
		echo "GREŠKA: 
		Problem sa upitom: ".$upit." : u datoteci bazaa.php funkcija izvrsiUput:  
		".mysqli_error($veza);
	}
